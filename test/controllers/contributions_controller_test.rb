...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { content: @contribution.content, contr_subtype: @contribution.contr_subtype, contr_type: @contribution.contr_type, parent_id: @contribution.parent_id, upvote: @contribution.upvote, url: @contribution.url, user_id: @contribution.user_id } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { content: @contribution.content, contr_subtype: @contribution.contr_subtype, contr_type: @contribution.contr_type, parent_id: @contribution.parent_id, upvote: @contribution.upvote, url: @contribution.url, user_id: @contribution.user_id } }
